    ...
    <>
      {showModal ? (
        <Modal isOpen={showModal} onClose={() => {}}>
          <p>
            By using this website you agree to usage of the "Privacy Policy"
            below
          </p>
          <p>
          ...
          <p>This app does not collect any data related to your usage.</p>
          <p>
            The app allows third parties to serve content, including
            advertisements just by virtue of Youtube doing so.
          </p>
          <p>
            See also{' '}
            ...
            .
            <p>
              I added this consent screen because Google asks users of their API
              to do so{' '}
